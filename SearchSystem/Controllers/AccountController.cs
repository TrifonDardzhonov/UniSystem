...
namespace SearchSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid && model.AuthorizationKey == ConfigurationManager.AppSettings["AuthorizationKey"])
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("ChooseDepartment", "CustomRegistration");
